 ...
 */
 ...
 /*
 * Thanks to Alexander Bothe ( info@alexanderbothe.com ) for D interface and 
...
// =============================================================================================================
  ...
  // =============================================================================================================
		...
		virtual int __stdcall OpenFileW(
			const WCHAR *sFileName,			// pointer to name of the file ( UNICODE ) 
			int nWaveBufferLengthMs,		// size of wave buffer ( milliseconds ), minimal 200
			unsigned int nSeekFromStart,	// number of bytes to move file pointer from file beginning	 
			unsigned int nFileSize			// size of file counting from nSeekFromStart position
		)= 0;
		...
		//
		//		sFileName		
		//			Points to a UNICODE string that specifies the name of the file.
		//		
		//		nWaveBufferLengthMs
		//			Size of wave buffer in milliseconds, must be at least 200. Smaller buffer produce
		//			smaller delay in effects ( echo, equalizer, fade .. ) and larger buffer produces
		...
		//	EXAMPLE 1:
		//
		// 	if(!mp3->OpenMp3File(L"mySong.mp3",2000, 48,10000)) // skip 48 bytes and play only next 10000 bytes
		//	{
		//		MessageBox(0,mp3->GetError(),"Error",0);
		//		return 0;
		//	}
		...
		//	EXAMPLE 2:
		//
		// 	if(!mp3->OpenMp3File(L"mySong.mp3",2000, 0,0)) // play whole file
		//	{
		//		MessageBox(0,mp3->GetError(),"Error",0);
		//		return 0;
		//	}
...
W_DECLSPEC int __stdcall Mp3_OpenFile(
			char *objptr,					// Pointer to class instance.
			const char *sFileName,			// pointer to name of the file ( ANSI )
			int nWaveBufferLengthMs,		// size of wave buffer ( milliseconds ), minimal 200
			unsigned int nSeekFromStart,	// number of bytes to move file pointer from file beginning	 
			unsigned int nFileSize			// size of file counting from nSeekFromStart position
);
...
W_DECLSPEC int __stdcall Mp3_OpenFileW(
			char *objptr,					// Pointer to class instance.
			const WCHAR *sFileName,			// pointer to name of the file ( UNICODE )
			int nWaveBufferLengthMs,		// size of wave buffer ( milliseconds ), minimal 200
			unsigned int nSeekFromStart,	// number of bytes to move file pointer from file beginning	 
